  ...
  render() {
    return (
      <div className="container-fluid text-monospace">
          ...
          <div className="col-md-2 border border-info overflow-auto text-center" style={{ maxHeight: '768px', minWidth: '175px' }}>
            <h5><b>Your Videos</b></h5>
            <form onSubmit={(event) => {
              ...
              &nbsp;
              <input type='file' accept=".mp4, .mkv .ogg .wmv" onChange={this.props.captureFile} style={{ width: '240px' }} />
